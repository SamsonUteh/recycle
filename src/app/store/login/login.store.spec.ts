...
import { login, loginFail, loginSucess, recoverPassword, recoverPasswordFail, recoverPasswordSuccess } from "./login.actions"
...
describe("Login store", () => {
  ...
  it('loginSuccess', () => {
    ...
    const user = new User();
    user.id = "anyId"
    const newState = loginReducer(initialState, loginSucess({user}));
    expect(newState).toEqual({
      ...initialState,
      isLoggedIn: true,
      isLoggingIn: false
